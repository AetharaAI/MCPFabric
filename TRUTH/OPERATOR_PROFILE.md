...
- There are 7 operational production VMs deployed in OVHcloud: 3 GPU instances and 4 CPU instances
- `L4-360` hosts the full voice stack, including batch and realtime ASR/TTS
- `L40S-90` hosts the LiteLLM-based Aether gateway and 1-2 smaller LLMs served through vLLM
- `L40S-180` hosts the company's flagship model, `mistral-small-4-119b-2603`

## Operating Expectations For Echo One
